...
class ProjectRangeEloquent implements ProjectRangeInterface
{
    private $model;

    /**
     * ProjectRangeEloquent constructor.
     * @param ProjectRangeInterface $model
     */
    public function __construct(ProjectRange $model)
    {
        $this->model = $model;
    }
