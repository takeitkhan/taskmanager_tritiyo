<?php
namespace Tritiyo\Task\Repositories\TaskMaterial;

use Tritiyo\Task\Models\TaskMaterial;

class TaskMaterialEloquent implements TaskMaterialInterface
{
    private $model;
     ...
     */
    public function __construct(TaskMaterial $model)
    {
        $this->model = $model;
    }
