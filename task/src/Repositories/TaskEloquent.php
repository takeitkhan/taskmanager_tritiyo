...
class TaskEloquent implements TaskInterface
{
    ...
    */
    ...
    public function advanced_search(array $options) {
        ...
        if($mo->project_id != NULL && $mo->project_id != "NonePrj") {
        ...
        if($mo->site_head_id != NULL && $mo->site_head_id != "None") {
            $site_head = " AND tasks_datas.site_head = $mo->site_head_id";
        } else {
            #$site_head = " AND tasks_datas.site = ''";
          	$site_head = " ";
        }

        if($mo->task_type != NULL && $mo->project_id != "NoneTT") {
