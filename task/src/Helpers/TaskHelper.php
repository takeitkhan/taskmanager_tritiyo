...
class TaskHelper
{
    ...
    {		
        ...
        $html .= '<a id="declineBtn" class="button is-danger is-small ml-2">Decline</a>';
        $html .= '<div id="declineReasonField"></div>';
        $html .= '<script>$(\'#declineBtn\').click(function(e){e.preventDefault();  let textArea = "<label class=\" \">Reason of decline<label><input required type=\"text\" name=\"decline_reason\" class=\"input\" /> <input type=\"submit\" name=\"decline[decline]\" value=\"Decline\" class=\"button is-danger is-small mt-2\"/>";';
