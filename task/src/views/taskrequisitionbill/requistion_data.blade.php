...
@else
    @if(is_array($vehicle))
        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
            ...
            <tr>
                <td>{{ \Tritiyo\Vehicle\Models\Vehicle::where('id', $v->vehicle_id)->first()->name ?? NULL }}</td>
    ...
    @if(is_array($material))
        <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
            ...
            <tr>
                <td>{{ \Tritiyo\Material\Models\Material::where('id', $m->material_id)->first()->name ?? NULL }}</td>
