                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                ...
                                <div class="control">
                                    {{ Form::number('da_amount', !empty($da) ? $da->da_amount : '', ['class' => 'input is-small requisition_rent_id',  'placeholder' => 'Enter DA amount...', 'min' => '0']) }}
                                </div>
                            </div>
                        </div>
                        <div class="column">
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                ...
                                <div class="control">
                                    {{ Form::number('labour_amount', !empty($labour) ? $labour->labour_amount : '', ['required', 'class' => 'input is-small requisition_rent_id', 'placeholder' => 'Enter labour amount...', 'v-model' => 'labour_amount']) }}
                                </div>
                            </div>
                        </div>
                        <div class="column">
                    ...
                    <div class="columns">
                        <div class="column">
                            <div class="field">
                                ...
                                <div class="control">
                                    {{ Form::number('other_amount', !empty($other) ? $other->other_amount : '', ['required', 'class' => 'input is-small requisition_rent_id', 'placeholder' => 'Enter other amount...', 'v-model' => 'other_amount']) }}
                                </div>
                            </div>
                        </div>
                        <div class="column">
