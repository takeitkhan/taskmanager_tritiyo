...
@section('column_left')
    <article class="panel is-primary" id="app">
        ...
        <div class="customContainer">
            ...
            {{ Form::open(['url' => $routeUrl, 'method' => $method, 'value' => 'PATCH', 'id' => 'add_route', 'class' => 'task_vehicle_table', 'files' => true, 'autocomplete' => 'off']) }}
                    ...
                    @foreach ($getTaskVehicle as $veh)
                        ...
                        <div class="columns s{{ $veh->id }}">
                            <div class="column is-2">
                                <div class="field">
                                    {{ Form::label('vehicle_id', 'Vehicle', ['class' => 'label']) }}
                                    <div class="control">
                            ...
                            <div class="column is-2">
                                {{ Form::label('vehicle_rent', 'Vehicle Rent', ['class' => 'label']) }}
                                {{ Form::number('vehicle_rent[]', $veh->vehicle_rent, ['class' => 'input is-small xvehicle_rent_id']) }}
                            </div>
                            <div class="column is-6">
                                {{ Form::label('vehicle_note', 'Note', ['class' => 'label']) }}
                                {{ Form::text('vehicle_note[]', $veh->vehicle_note, ['class' => 'input is-small']) }}
                            </div>
